...
class Card extends Component {
    ...
    constructor() {
        ...
        this.handleFormSubmt = this.handleFormSubmit.bind(this);
    }
    ...
    render() {
       ...
       return (
           <form onSubmit={this.handleFormSubmt}className="card">
               ...
               <button type ="submit">{!this.state.contentVisible ? 'Generate Mad Lib' : 'Clear Form'}Generate Mad Lib</button>
               {
